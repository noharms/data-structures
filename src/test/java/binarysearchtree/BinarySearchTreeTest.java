...
class BinarySearchTreeTest {
    ...
    @Test
    public void emptyTree_remove_gives_emptyOptionals() {
        BinarySearchTree<Integer, Integer> bst = new BinarySearchTree<>();
        assertEquals(Optional.empty(), bst.remove(0));
        assertEquals(Optional.empty(), bst.remove(-1));
        assertEquals(Optional.empty(), bst.remove(1));
        assertEquals(Optional.empty(), bst.remove(2));
        assertEquals(Optional.empty(), bst.remove(-2));
    }
